...
def moveToPoint2(pose, reference):
    ...
    distance = np.sqrt(error[0]**2 + error[1]**2) # Distance Euclidan
    referenceAngle = np.arctan2(error[1], error[0]) # Theta
    error_positioning = referenceAngle - pose[2] # Gammac
...
while True:
    ...
    if t_now >= samp_time*n:
        ...
        # Mode: Object Follower
            ...
            v_trans, v_rot =  (object_distance[2], object_distance[3], object_distance[4], object_distance[5])
